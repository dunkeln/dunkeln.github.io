export const projects = [
  {
    name: 'Browser policy RFT',
    scope: 'Across 128 MiniWoB training rollouts, RFT raised mean reward from 53.13% to 57.81%; matched held-out runs cut repeated-action loops from 26 to 17 while an execution gate quarantined 17 incomplete trajectories.',
    image: '/assets/work/browser-policy-rft.svg',
    alt: 'Chart showing MiniWoB training reward gains, held-out execution improvements, and trajectory admission',
    width: 1000,
    height: 1000,
    repo: 'https://github.com/dunkeln/browseruse_ft',
  },
  {
    name: 'procdork',
